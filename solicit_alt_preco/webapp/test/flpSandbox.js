		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Solicitação de alteração de preço de produtos",
									"targetURL": "#deiadesafio5psolicitaltpreco-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"deiadesafio5psolicitaltpreco-display": {
								"semanticObject": "deiadesafio5psolicitaltpreco",
								"action": "display",
								"description": "Solicitação de alteração de preço de produtos",
								"title": "Solicitação de alteração de preço de produtos",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=deia.desafio5p.solicitaltpreco",
									"url": sap.ui.require.toUrl("deia/desafio5p/solicitaltpreco")
								}
							}
						}
					}
